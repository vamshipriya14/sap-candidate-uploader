"""
pages/Resume_Upload_NoAuth.py — Direct Resume Upload (no SSO login required)
...
This is the same as Resume_Upload.py but WITHOUT SSO authentication.
"""
...
if st.session_state.upload_rows:
    ...
    # ══════════════════════════════════════════════════════════════════════
    if do_submit and jr_no and recruiter_email:
        ...
        for idx, row in enumerate(merged):
            ...
            try:
                # Since there's no logged-in user, create a minimal user dict
                user = {
