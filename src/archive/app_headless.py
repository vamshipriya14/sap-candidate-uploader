...
if not st.session_state.email_drafts_df.empty:
    ...
    with col1:
        recruiter_name = st.text_input(
            ...
            value=str(draft_row.get("Client Recruiter Name", "")),
            key=f"draft_recruiter_name_{selected_idx}",
            width="stretch",
        )
        email_to = st.text_input(
            "Email To",
            value=str(draft_row.get("Email To", "")),
            key=f"draft_email_to_{selected_idx}",
            width="stretch",
        )
        email_from = st.text_input(
            "Email From",
            value=str(draft_row.get("Email From", "")),
    ...
    with col2:
        jr_number = st.text_input(
            "JR Number",
            value=str(draft_row.get("JR Number", "")),
        ...
        subject = st.text_input(
            "Subject",
            value=str(draft_row.get("Subject", "")),
    ...
    body_text = st.text_area(
        "Email Body",
        value=str(draft_row.get("Email Body", "")),
